...
export default async function SignInPage({searchParams}: {
  ...
  return (
    <div className=" justify-between items-center content-center  h-screen flex flex-col gap-2 bg-gradient-to-tr from-login-form to-login-form">
...
<div className=" bg-gradient-to-tr from-login-form to-80% transition-all  duration-75 w-fit max-sm:w-fit max-sm:h-[auto]  h-[auto] justify-between flex flex-col rounded-md p-4 gap-3">
        <form
